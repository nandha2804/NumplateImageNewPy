...
class PlateFinder:
    ...
    def extract_contours(self, image):
        ...
        """
        contours, _ = cv2.findContours(image, mode=cv2.RETR_LIST, method=cv2.CHAIN_APPROX_NONE)
        return contours, None, None  # Replace None with the appropriate values if needed
